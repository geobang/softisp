...
class ResizeV1(ResizeBase):
    ...
    def build_algo(self, stage: str, prev_stages=None):
        ...
        nodes.append(oh.make_node('Resize', inputs=[rgb, scales], outputs=[applier], name=f'{stage}.resize', mode='linear'))
        vis.append(oh.make_tensor_value_info(applier, TensorProto.FLOAT, ['n', 3, 'h/2', 'w/2']))
        outputs = {'applier': {'name': applier}, 'resize_factor': {'name': resize_factor}}
