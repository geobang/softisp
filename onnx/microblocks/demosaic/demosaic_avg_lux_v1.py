# onnx/microblocks/demosaic/demosaic_avg_lux_v1.py
...
class DemosaicAvgLuxV1(DemosaicBase):
    ...
    def _split_rggb(self, stage, input_image, nodes, vis):
        ...
        vis += [
            ...
            oh.make_tensor_value_info(g1, TensorProto.FLOAT, ["n", 1, "h", "w"]),
            oh.make_tensor_value_info(g2, TensorProto.FLOAT, ["n", 1, "h", "w"]),
            oh.make_tensor_value_info(b, TensorProto.FLOAT, ["n", 1, "h", "w"]),
        ]
        return r, g1, g2, b

    # -----------------------------
    # Phase 2: average greens
    # -----------------------------
